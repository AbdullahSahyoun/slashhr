// _employee/controllers/employeeLetterHistoryController.js
import { getEmployeeLetterHistory } from '../models/emplpyeeLetterHistory.modal.js';
...
/**
 * GET /employee/:id/letter-history
 */
export async function listEmployeeLetterHistory(req, reply) {
  try {
    ...
    const db = getDb(req);
    const items = await getEmployeeLetterHistory(db, employeeId);
