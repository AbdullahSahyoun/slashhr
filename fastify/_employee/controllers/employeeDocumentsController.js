// _employee/controllers/employeeDocumentsController.js
import { getEmployeeDocuments } from '../models/employeeDocuments.model.js';
 ...
 */
export async function listEmployeeDocuments(req, reply) {
  try {
    ...
    const db = getDb(req);
    const items = await getEmployeeDocuments(db, employeeId);

    // If you want limit/offset later, do it in the model for efficiency.
